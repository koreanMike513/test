...
public class FoodReservationOrReleaseFailedEventHandler {

  private final OrderService orderService;

  @KafkaHandler
  public void processFoodReservationFailEvent(@Payload FoodReservationOrReleaseFailedEvent foodReservationOrReleaseFailedEvent) {
    orderService.updateOrderStatus(
        foodReservationOrReleaseFailedEvent.getOrderId(),
        ErrorCodeOrderStatusTranslator.translate(foodReservationOrReleaseFailedEvent.getErrorCode()));
  }
}
